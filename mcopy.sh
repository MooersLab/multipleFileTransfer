...
echo "afplay is a Unix program that plays an audio file. It might run on Mac OS X."
echo "The `say` program on Mac OS will convert text to speech. The espeak program is the Linux analog."
